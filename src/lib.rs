...
pub fn read_magic_string(pos: &mut Iter<'_, u8>) -> Result<bool> {
...
/// Read edges
pub fn read_n_successors(pos: &mut Iter<'_, u8>, endianness: Endianness, n_bytes_per_node_identifier: usize, n_successors: usize) -> std::io::Result<Vec<usize>> {
